                        ...
                        {isConnected ? (
                            accountAddress.toLowerCase() === event.eventOwner.toLowerCase() ? (
                                <section>
                                    ...
                                    <h6 className="text-sm mt-4 mb-1">{formatTimestamp(event.eventTimestamp)}</h6>
                                    <h1 className="text-2xl tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-4xl mb-[2.5rem]">
                                        {event.name}
                                    </h1>
